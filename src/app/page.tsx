    ...
    <main id="main">
      <section className="hero">
        <div className="wrap">
          ...
          <h1 className="display">Ohio State&apos;s co-ed <span className="terminal">technology fraternity.</span></h1>
      ...
      <section className="stat-band" aria-label="Chapter statistics"><div className="wrap stats"><div><strong>{members.filter(m=>m.role!=="alumni").length}+</strong><span>active members</span></div><div><strong>6</strong><span>pledge classes</span></div><div><strong>5</strong><span>grad years</span></div><div><strong>9</strong><span>companies represented</span></div></div></section>
